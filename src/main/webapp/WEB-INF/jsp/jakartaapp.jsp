...
<%@include file="/WEB-INF/jspf/cabecalhos.jspf" %>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <%
        String title = "jakartaapp :: Informações de diagnóstico";
...
<div class="container mt-5">
    ...
    <div class="d-md-flex flex-md-row-reverse align-items-center justify-content-between">
        <div class="mb-3 mb-md-0 d-flex text-nowrap"><a class="btn btn-sm btn-bd-light rounded-2" href="https://github.com/evertonagilar/jakartaapp" title="View and edit this file on GitHub" target="_blank" rel="noopener">
            View on GitHub
        </a>
        </div>
